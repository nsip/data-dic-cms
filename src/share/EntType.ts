...
export class EntType {
    ...
    SetMeta(
        ...
        switch (TYPE) {
            case "html":
                this.Metadata.Superclass = validStrHTMLArr(
                    superclass,
                    this.Metadata.Superclass
                );
                this.Metadata.ExpectedAttributes = validStrHTMLArr(
                    attrStr,
                    this.Metadata.ExpectedAttributes
                );
                this.Metadata.CrossrefEntities = validStrHTMLArr(
                    crossref,
                    this.Metadata.CrossrefEntities
                );
                break;
            default:
                this.Metadata.Superclass = validStrTEXTArr(
                    superclass,
                    this.Metadata.Superclass
                );
                this.Metadata.ExpectedAttributes = validStrTEXTArr(
                    attrStr,
                    this.Metadata.ExpectedAttributes
                );
                this.Metadata.CrossrefEntities = validStrTEXTArr(
                    crossref,
                    this.Metadata.CrossrefEntities
                );
        }
