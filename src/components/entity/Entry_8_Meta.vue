  ...
  <div class="com">
    ...
    <div :hidden="!visEditor">
      ...
      <QuillEditor
        theme="snow"
        toolbar="essential"
        placeholder="expected attributes"
        @ready="onReady"
      ...
      <QuillEditor
        theme="snow"
        toolbar="essential"
        placeholder="superclasses"
        @ready="onReady"
        @textChange="textChange(3)"
      />
      <hr class="subline" />
      <QuillEditor
        theme="snow"
        toolbar="essential"
        placeholder="cross ref entities"
        @ready="onReady"
        @textChange="textChange(4)"
      />
    </div>
  </div>
</template>
